...
set -x
jq 'del(.channel_group.groups.Application.groups.RancherMSP)' blockchain/channel-artifacts/config.json > blockchain/channel-artifacts/modified_config.json 
...
successln "Config transaction to remove rancher to network submitted"
