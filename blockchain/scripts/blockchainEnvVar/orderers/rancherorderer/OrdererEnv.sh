...
set_variables() {
    ...
    export CORE_ORDERER_PEER_ADDRESS="localhost:7049"
    export CORE_ORDERER_CONTAINER_ADDRESS="rancherorderer.beefsupply.com"
    export CORE_ORDERER_ADMIN_LISTEN_ADDRESS="localhost:7043"
