...
createAnchorPeerUpdate() {
  ...
  elif [ $ORG = "farmer0" ]; then
    HOST="peer0.farmer.beefsupply.com"
    PORT=8051  
  elif [ $ORG = "breeder0" ]; then
    HOST="peer0.breeder.beefsupply.com"
    PORT=10051
  elif [ $ORG = "breeder1" ]; then
    HOST="peer0.breeder1.beefsupply.com"
    PORT=13051
  elif [ $ORG = "processor0" ]; then
    HOST="peer0.processor.beefsupply.com"
    PORT=14051
  elif [ $ORG = "processor1" ]; then
    HOST="peer0.processor1.beefsupply.com"
    PORT=15051
  elif [ $ORG = "processor2" ]; then
    HOST="peer0.processor2.beefsupply.com"
    PORT=16051
  elif [ $ORG = "distributor0" ]; then
    HOST="peer0.distributor.beefsupply.com"
    PORT=17051
  elif [ $ORG = "distributor1" ]; then
    HOST="peer0.distributor1.beefsupply.com"
    PORT=18051
  elif [ $ORG = "distributor2" ]; then
    HOST="peer0.distributor2.beefsupply.com"
    PORT=19051
  elif [ $ORG = "distributor3" ]; then
    HOST="peer0.distributor3.beefsupply.com"
    PORT=20051
  elif [ $ORG = "retailor0" ]; then
    HOST="peer0.retailor.beefsupply.com"
    PORT=21051    
  elif [ $ORG = "retailor1" ]; then
    HOST="peer0.retailor1.beefsupply.com"
    PORT=22051
  elif [ $ORG = "retailor2" ]; then
    HOST="peer0.retailor2.beefsupply.com"
    PORT=23051   
  elif [ $ORG = "retailor3" ]; then
    HOST="peer0.retailor3.beefsupply.com"
    PORT=24051
  elif [ $ORG = "retailor4" ]; then
    HOST="peer0.retailor4.beefsupply.com"
    PORT=25051
  elif [ $ORG = "consumer0" ]; then
    HOST="peer0.consumer.beefsupply.com"
    PORT=26051
