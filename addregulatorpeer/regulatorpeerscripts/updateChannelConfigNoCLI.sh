...
setGlobals manager0_0
  ...
  set -x
  peer channel fetch 0 blockchain/channel-artifacts/$CHANNEL_NAME.block -o localhost:7050 --ordererTLSHostnameOverride orderer.beefsupply.com -c $CHANNEL --tls --cafile "$ORDERER_CA"
  { set +x; } 2>/dev/null
  
  peer channel list


  setGlobals regulator0_1
